...
Compared to a standard LLM-based fashion chatbot, this project includes:

- Retrieval-driven recommendations
- Explicit compatibility engine
- Hybrid metadata + image retrieval
- Outfit assembly logic
- Compatibility scoring
- Dataset-grounded explanations
- Outfit board generation using actual dataset images
